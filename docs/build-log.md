...
This document provides a high-level timeline of the Hybrid Enterprise & Cloud Security Lab. Detailed documentation for each session is maintained in the `docs` directory.
...
Refer to the project `README.md` for the current architecture, roadmap, technologies, and project status.